 ...
 * changes and enqueues these changes for processing by the ScreenRecorder.
 */
public class MouseGrabber implements Runnable, AutoCloseable {
	...
	private void grabMouse() throws InterruptedException {
		...
		mouseWasPressed = mousePressed.get();
	}
