...
/// A demo for the [QuickTimeWriter] class.
///
...
public class Main extends javax.swing.JFrame {
    ...
    private class FormListener implements java.awt.event.ActionListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == chooseImageFolderButton) {
                Main.this.chooseImageFolder(evt);
            } else if (evt.getSource() == chooseSoundFileButton) {
                Main.this.chooseSoundFile(evt);
            } else if (evt.getSource() == createMovieButton) {
                Main.this.createMovie(evt);
            } else if (evt.getSource() == noPreparationRadio) {
                Main.this.streamingRadioPerformed(evt);
    ...
    private void createMovie(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createMovie
        ...
        BackgroundTask w = new BackgroundTask() {
            ...
            protected void failed(Throwable t) {
                t.printStackTrace();
                JOptionPane.showMessageDialog(Main.this, "<html>Creating the QuickTime Movie failed.<br>" + (t.getMessage() == null ? t.toString() : t.getMessage()), "Sorry", JOptionPane.ERROR_MESSAGE);
            }
    ...
    private void writeVideoOnlyVFR(File movieFile, File[] imgFiles, int width, int height, double fps, Format videoFormat, boolean passThrough, String streaming) throws IOException {
        ...
        ProgressMonitor p = new ProgressMonitor(Main.this, "Creating " + movieFile.getName(), "Creating Output File...", 0, imgFiles.length);
        Graphics2D g = null;
    ...
    private void writeAudioOnly(File movieFile, File audioFile, String streaming) throws IOException {
        ...
        ProgressMonitor p = new ProgressMonitor(Main.this, "Creating " + movieFile.getName(), "Initializing...", 0, length);
        ...
        try {
            ...
            //System.out.println("Main " + audioFormat);
