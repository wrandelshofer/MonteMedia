...
///
/// `MP4Writer` works with tracks and samples. After creating a
/// `MP4Writer` one or more video and audio tracks can be added to
...
/// `MP4Writer`. Alternatively, you can plug in your own codec.
///
