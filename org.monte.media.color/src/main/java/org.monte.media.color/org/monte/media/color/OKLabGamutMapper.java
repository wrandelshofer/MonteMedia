...
public class OKLabGamutMapper implements GamutMapper {
    ...
    public float[] map(float[] oklab, float[] srgb) {
        ...
        okLabColorSpace.toLinearRGB(oklab, lrgb);
        RGB clippedRgb = gamut_clip_preserve_chroma(new RGB(lrgb[0], lrgb[1], lrgb[2]));
        lrgb[0] = clippedRgb.r;
        lrgb[1] = clippedRgb.g;
        lrgb[2] = clippedRgb.b;
    ...
    private static RGB gamut_clip_preserve_chroma(RGB rgb) {
        ...
        return oklab_to_linear_srgb(new Lab(L_clipped, C_clipped * a_, C_clipped * b_));
    }

    private static RGB oklab_to_linear_srgb(Lab c) {
    ...
    private static Lab linear_srgb_to_oklab(RGB c) {
    ...
    private static LC find_cusp(float a, float b) {
        ...
        RGB rgb_at_max = oklab_to_linear_srgb(new Lab(1, S_cusp * a, S_cusp * b));
