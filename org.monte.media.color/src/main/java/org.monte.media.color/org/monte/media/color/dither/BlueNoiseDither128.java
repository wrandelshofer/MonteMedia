...
/// 128x128 blue noise dither matrix.
///
/// References:
///
...
///
public class BlueNoiseDither128 implements Dither {
    ...
    public BlueNoiseDither128(float spread) {
        this(0, spread);
    }
    ...
    /// @param spread  the multiplication factor applied to the matrix values. With spread=1 the values are in the range [-1,+1].
    public BlueNoiseDither128(int channel, float spread) {
