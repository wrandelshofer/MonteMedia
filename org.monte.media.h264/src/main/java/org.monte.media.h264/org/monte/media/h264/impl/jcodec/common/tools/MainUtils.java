...
import org.monte.media.h264.impl.jcodec.common.StringUtils;
import org.monte.media.h264.impl.jcodec.common.io.IOUtils;
...
public class MainUtils {
    ...
    public static class Cmd {
        ...
        private Long getLongFlagInternal(Map<String, String> longFlags, Map<String, String> shortFlags, Flag flag,
                                         Long defaultValue) {
            return longFlags.containsKey(flag.getLongName()) ? Long.valueOf(longFlags.get(flag.getLongName()))
                    : (shortFlags.containsKey(flag.getShortName()) ? Long.valueOf(shortFlags.get(flag.getShortName()))
                    : defaultValue);
        }
        ...
        private Double getDoubleFlagInternal(Map<String, String> longFlags, Map<String, String> shortFlags, Flag flag,
                                             Double defaultValue) {
            return longFlags.containsKey(flag.getLongName()) ? Double.valueOf(longFlags.get(flag.getLongName()))
                    : (shortFlags.containsKey(flag.getShortName()) ? Double.valueOf(shortFlags.get(flag.getShortName()))
                    : defaultValue);
        }
