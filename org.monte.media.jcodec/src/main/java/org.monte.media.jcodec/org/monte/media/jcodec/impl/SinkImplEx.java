...
public class SinkImplEx implements Sink, PacketSink {
    ...
    public static SinkImplEx createWithStream(SeekableByteChannel destStream, Format outputFormat, Codec outputVideoCodec, Codec outputAudioCodec) {
        SinkImplEx result = new SinkImplEx(null, outputFormat, outputVideoCodec, outputAudioCodec);
