...
public class IFFParser
    ...
    ///
    /// Pre condition
    ///   - 	Data-, property- and collection chunks must have been declared
    ///     prior to this call.   - 	When the client never declared chunks, then all
    ///     local chunks will be interpreted as data chunks.   -
    ///     The stream must be positioned at the beginning of the IFFFileExpression.
    ///
    ///
    /// Post condition
    ///   - 	When no exception was thrown then the stream is positioned after
    ...
    ///
    /// Pre condition
    ///   - 	Data chunks must have been declared before the interpretation
    ///     has been started.   - 	This method will always return true when neither
    ...
    ///
    /// Pre condition
    ///   - 	Group chunks must have been declared before the interpretation
    ///     has been started. (Otherwise the response is always true).
    ///
    /// @param chunk Chunk to be verified.
    ...
    /// Pre condition
    ///
    ///   - 	Property chunks must have been declared before the interpretation
    ///     has been started.
    ///   - 	This method will always return false when neither data chunks,
    ///     property chunks nor collection chunks have been declared.
    ///
    ...
    /// Pre condition
    ///
    ///   - 	Collection chunks must have been declared before the interpretation
    ///     has been started.
    ///   - 	This method will always return true when neither data chunks,
    ///     property chunks nor collection chunks have been declared.
    ///
    /// @param chunk Chunk to be verified.
    ...
    ///     type.
    ///   - 	Declarations may not be done during interpretation of an
    ///     IFFFileExpression.
    ///
    ///
    ...
    /// Pre condition
    ///
    ///   - 	The chunk must not have already been declared as
    ///     of a different type.
    ///   - 	Declarations may not be done during
    ///     interpretation of an IFFFileExpression.
    ///
    ///
    /// Post condition
    ///   - 	Group chunk declared
    ...
    ///
    /// Validation
    ///   - 	Local Chunk IDs may not be a NULL_ID and may not have
    ...
    /// Validation:
    ///
    ///   - 	The FORM type is a restricted ID that may not contain
