...
/// Amiga display info database.
public class AmigaDisplayInfoDatabase {
    ...
    private static Map<Integer, AmigaDisplayInfo> infos;
    ...
    public static Map<Integer, AmigaDisplayInfo> getAllInfos() {
        if (infos == null) {
            var map = new TreeMap<Integer, AmigaDisplayInfo>();
            for (Object[] e : infoTable) {
                ...
                map.put(camg, new AmigaDisplayInfo(camg, name, textOverscan, maxOverscan, minimalSize, maximalSize, colorRegisterDepth, resolution, pixelSpeed, fps));
            }
            infos = Collections.unmodifiableMap(map);
        }
        return infos;
    }
    ...
    private record MonitorItem(String name, int fps) {
    }
