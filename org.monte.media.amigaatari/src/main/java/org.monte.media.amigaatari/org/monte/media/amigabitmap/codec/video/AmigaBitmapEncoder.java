...
/**
 * Encodes a {@link BufferedImage} into a {@link AmigaBitmapImage}.
 *
 * @author Werner Randelshofer
 */
public class AmigaBitmapEncoder extends org.monte.media.av.AbstractCodec {
    public AmigaBitmapEncoder() {
        super(new Format[]{
    ...
    private int decodeToBitmapImage(Buffer in, Buffer out) {
        ...
        try {
            ...
            return success ? CODEC_OK : CODEC_FAILED;
        } catch (IOException e) {
            out.exception = e;
            out.setFlag(DISCARD);
            return CODEC_FAILED;
