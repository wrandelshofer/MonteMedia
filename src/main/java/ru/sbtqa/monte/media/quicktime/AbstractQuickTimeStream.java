...
import static ru.sbtqa.monte.media.quicktime.AbstractQuickTimeStream.States.REALIZED;
...
public class AbstractQuickTimeStream {
        ...
        public void finish() throws IOException {
            if (!finished) {
                ...
                if (sizeBefore != sizeAfter) {
                    err.println("size mismatch " + sizeBefore + ".." + sizeAfter);
                }
            }
        }
    ...
    protected abstract static class Group {
        ...
        protected final static long maxSampleCount = MAX_VALUE;
