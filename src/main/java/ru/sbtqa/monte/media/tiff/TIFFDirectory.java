...
public class TIFFDirectory extends TIFFNode {
    ...
    /**
     * The IFD from which this directory was read. ifd is null, if this
     * directory has not been read from a TIFF file.
     */
    private IFD ifd;
    /**
     * Segments of the TIFF file which hold the IFD. tiffSegments is null, if
     * this directory has not been read from a TIFF file.
     */
    ...
    /**
     * Creates a TIFFDirectory identified by the specified TIFFTag and
     * associated with the specified IFD and file segments.
     *
     * @param tagSet TODO
     * @param fileSegments TODO
     * @param tag TODO
     * @param parentEntry TODO
     * @param index TODO
     * @param ifd TODO
     */
    ...
    /**
     * Returns the segments of the TIFF file inside its parent file. In a JPEG
     * JFIF stream, a TIFF file can be segmented over multiple APP markers.
     *
    ...
    /**
     * Returns a TIFFField with the specified tag. If a child node with this tag
     * exists.
     *
     * @param tag TODO
     * @return TODO
    ...
    /**
     * Returns the value of the TIFFField with the specified tag. If a child
     * node with this tag exists.
     *
     * @param tag TODO
     * @return TODO
     */
