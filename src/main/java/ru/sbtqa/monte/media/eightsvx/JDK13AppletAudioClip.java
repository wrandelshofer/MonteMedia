 ...
 * Copyright © 2003-2013 Werner Randelshofer, Switzerland.
...
/**
 * JDK13AppletAudioClip. Supports playback of JDK13_SAMPLE_RATE Hz linear 8
 * encoded PCM data. This class is designed and tuned for use in applets. It is
 * not recommended to use this class in Java applications.
 *
...
public class JDK13AppletAudioClip implements LoopableAudioClip, Runnable {
    ...
    /**
     * All instances share this mixer. Aquiring a line from a mixer is faster
     * than aquiring it from AudioSystem directly.
     */
    private static Mixer mixer;

    /**
     * This vector holds a pool of SourceDataLine objects. All SourceDataLine
     * objects in this vector are open() and stopped. This vector is used to
     * improve the audio playback performance because opening a SourceDataLine
     * may take a long time.
     */
    private static LinkedList<SourceDataLine> lines = new LinkedList<SourceDataLine>();

    /**
     * The only place where the workerThread variable is changed is in the
     * loop(int) method and in the stop() method. For all other methods this
     * variable is strictly <bold>read only</bold>!
     */
    ...
    /**
     * Lazily creates the shared mixer instance and returns it. Puts 8 lines
     * into the pool.
     */
    ...
    /**
     * Tries to get a SourceDataLine from the cache. If none is available, a new
     * line is created and opened.
     */
    ...
    /**
     * Adds a line to the pool and makes it available for reuse. If more than 16
     * lines are in the cache, then the line is closed.
     */
     ...
     * create a workerThread, starting the workerThread causes the object's
