/* @(#)Interpolator.java
 * Copyright © 2003-2008 Werner Randelshofer
...
public abstract class Interpolator {
    ...
    /**
     * Computes a fraction from the specified linear fraction. In the simplest
     * case, this method returns the linear fraction. The returned value must be
     * between 0 and 1.
     *
    ...
    /**
     * Returns true, if this interpolator replaces interpolations by that
     * interpolator.
     *
     * @param that TODO
     * @return TODO
     ...
     * 
     * Once this method has been called, method #finish must be called before
     * the interpolator can be destroyed.
     *
