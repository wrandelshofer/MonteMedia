...
public class TreeNodeImpl<T extends TreeNodeImpl<T>> extends DefaultMutableTreeNode {
    ...
    public Iterable<T> breadthFirstIterable() {
        return new Iterable<T>() {
            ...
            public Iterator<T> iterator() {
                return new EnumerationIterator<>((Enumeration<T>) (Enumeration<?>) breadthFirstEnumeration());
            }
    ...
    public List<T> getChildren() {
        if (children == null) {
            ...
            return unmodifiableList((List<T>) (List<?>) children);
        }
    }
    ...
    public Iterable<T> depthFirstIterable() {
        return new Iterable<T>() {
            ...
            @SuppressWarnings("unchecked")
            public Iterator<T> iterator() {
                return new EnumerationIterator<>((Enumeration<T>) (Enumeration<?>) depthFirstEnumeration());
            }
