...
/**
 * A RIFF primitives input stream lets an application read primitive data types
 * in the Microsoft Resource Interfache File Format (RIFF) format from an
 * underlying input stream.
 *
 * Reference: AVI RIFF File Reference
...
public class RIFFPrimitivesInputStream extends FilterInputStream {
    ...
    /**
     * Read 1 byte from the input stream and interpret them as an 8 Bit unsigned
     * UBYTE value.
     *
     * @return TODO
    ...
    /**
     * Read 2 bytes from the input stream and interpret them as a 16 Bit signed
     * WORD value.
     *
     * @return TODO
     * @throws java.io.IOException TODO
    ...
    /**
     * Read 2 bytes from the input stream and interpret them as a 16 Bit
     * unsigned UWORD value.
     *
     * @return TODO
     * @throws java.io.IOException TODO
     */
    ...
    /**
     * Read 4 bytes from the input stream and interpret them as a 32 Bit signed
     * LONG value.
     *
     * @return TODO
     * @throws java.io.IOException TODO
    ...
    /**
     * Read 4 bytes from the input stream and interpret them as a four byte
     * character code.
     *
     * Cited from Referenced "AVI RIFF File Reference": "A FOURCC
     * (four-character code) is a 32-bit unsigned integer created by
     ...
     * @return TODO
     * @exception IOException if this input stream does not support seek or if
     * some other I/O error occured.
     */
