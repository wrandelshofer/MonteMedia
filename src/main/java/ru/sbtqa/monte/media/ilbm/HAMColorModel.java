...
public class HAMColorModel extends DirectColorModel {
    ...
    public final static int HAM6 = 6,
          HAM8 = 8;
    ...
    /**
     * Returns the number of planes required to represent this HAMColorModel in
     * a Bitmap.
     *
     * @return TODO
     */
    ...
    /**
     * Copies the array of red color components into the given array. Only the
     * initial entries of the array as specified by getMapSize() are written.
     *
     * @param r TODO
     */
    ...
    /**
     * Copies the array of green color components into the given array. Only the
     * initial entries of the array as specified by getMapSize() are written.
     *
     * @param g TODO
     */
    ...
    /**
     * Copies the array of blue color components into the given array. Only the
     * initial entries of the array as specified by getMapSize() will be
     * written.
     *
     * @param b TODO
     */
    ...
    /**
     * Copies the array of color components into the given array. Only the
     * initial entries of the array as specified by getMapSize() will be
     * written.
     *
     * @param rgbs TODO
