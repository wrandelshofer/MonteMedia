...
public class StateTracker
    ...
    /**
     * Sets the StateModel. Note: This method must not be called while one of
     * the waitForState methods is working.
     *
    ...
    /**
     * Waits until the StateModel reaches the indicated state. Note:
     * waitForState methods may not be called from multiple threads
     * simoultaneously.
     *
     ...
     *
     * Note: waitForState methods may not be called from multiple threads
     * simoultaneously.
     *
    ...
    /**
     * XXX This method is public as an implementation side effect. " Do not call
     * or override.
     *
     * @param event TODO
     */
