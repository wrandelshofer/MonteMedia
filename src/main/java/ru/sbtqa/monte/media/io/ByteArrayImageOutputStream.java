...
/**
 * This class implements an image output stream in which the data is written
 * into a byte array. The buffer automatically grows as data is written to it.
 * The data can be retrieved using
 * {@code toByteArray()}, {@code toImageOutputStream()} and
 * {@code toOutputStream()}.
 * 
...
public class ByteArrayImageOutputStream extends ImageOutputStreamImpl {
    ...
    public int read(byte b[], int off, int len) throws IOException {
        ...
        arraycopy(buf, (int) streamPos, b, off, len);
        streamPos += len;
        return len;
    }
    ...
    public void write(int b) throws IOException {
        ...
        if (newcount > buf.length) {
            buf = copyOf(buf, max(buf.length << 1, (int) newcount));
        }
    ...
    public void write(byte b[], int off, int len) throws IOException {
        ...
        arraycopy(b, off, buf, (int) streamPos, len);
        streamPos += len;
        count = newcount;
    }
    ...
    public byte[] toByteArray() {
        ...
        arraycopy(buf, arrayOffset, copy, 0, count);
        return copy;
    }
