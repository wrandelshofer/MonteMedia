...
public class BoundedRangeInputStream
    ...
    /**
     * Overrides <code>FilterInputStream.read</code> to update the value after
     * the read.
     *
     * @return TODO
    ...
    /**
     * Overrides <code>FilterInputStream.skip</code> to update the value after
     * the skip.
     *
     * @return TODO
     * @throws java.io.IOException TODO
    ...
    /**
     * Increments the extent by the indicated value. Negative Increments are
     * ignored.
     *
     ...
     * 
     * minimum {@literal <}= value {@literal <}= value+extent {@literal <}= maximum
     * 
     * 
    ...
    /**
     * Ignored: The maximum of an input stream can not be changed. # Sets the
     * model's maximum to <I>newMaximum</I>. The other three properties may be
     ...
     * <code>minimum</code> it's set to <code>minimum</code>, if its greater
     * than <code>maximum</code> then it's set to <code>maximum</code>, and if
     * it's greater than <code>value+extent</code> then it's set to
