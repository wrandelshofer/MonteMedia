...
import static ru.sbtqa.monte.media.ilbm.HAMColorModel.HAM6;
import static ru.sbtqa.monte.media.ilbm.HAMColorModel.HAM8;
...
public class BitmapImage
    ...
    public int convertToChunky(int top, int left, int bottom, int right) {
        ...
        if (planarColorModel instanceof HAMColorModel) {
            ...
            if (((HAMColorModel) planarColorModel).getHAMType() == HAM6) {
                ham6PlanesToDirectPixels(top, left, bottom, right);
            } else if (((HAMColorModel) planarColorModel).getHAMType() == HAM8) {
