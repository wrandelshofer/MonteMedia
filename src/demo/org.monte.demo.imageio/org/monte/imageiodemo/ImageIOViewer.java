 ...
 * @version $Id: ImageIOViewer.java 364 2016-11-09 19:54:25Z werner $
 */
public class ImageIOViewer extends javax.swing.JPanel {
        ...
        public void drop(DropTargetDropEvent event) {
            if (event.isDataFlavorSupported(DataFlavor.javaFileListFlavor)) {
                ...
                try {
                    ...
                    JOptionPane.showConfirmDialog(ImageIOViewer.this,
    ...
    public void showImages(final List<File> files) {
        ...
        new Worker<Image>() {
            ...
            protected void done(Image value) {
                ...
                SwingUtilities.getWindowAncestor(ImageIOViewer.this).pack();
            }
