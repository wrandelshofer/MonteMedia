 ...
 */
package org.monte.demo.animmerger;
            ...
            if (chooser.showDialog(this, "Open File 2") == JFileChooser.APPROVE_OPTION) {
                ...
                new BackgroundTask() {
                    ...
                    public void failed(Throwable result) {
                        ...
                        JOptionPane.showMessageDialog(Main.this, "<html>Error merging files<br>" + result, "AnimMerger", JOptionPane.ERROR_MESSAGE);
                    }

                    @Override
                    public void done() {
                        JOptionPane.showMessageDialog(Main.this, "Done", "AnimMerger", JOptionPane.INFORMATION_MESSAGE);
                    }
                }.start();
            }
        }
