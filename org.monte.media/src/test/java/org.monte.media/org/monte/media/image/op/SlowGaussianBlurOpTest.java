...
public class SlowGaussianBlurOpTest {
    ...
    public void shouldConvolveImageUsingGaussian(float sigma) throws IOException {
        ...
        var op = new SlowGaussianBlurOp(sigma);
        ...
        boolean success = ImageIO.write(destSRgb, "PNG", new File("target/SlowGaussianBlurOp-" + sigma + ".png"));
    }
}