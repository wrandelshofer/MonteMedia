...
/// Approximates a Gaussian filter by applying three Box filters.
///
...
public class BoxGaussianOp implements BufferedImageOp {
    private final float sigmaX;
    private final float sigmaY;

    public BoxGaussianOp(float sigma) {
        this(sigma, sigma);
    }

    public BoxGaussianOp(float sigmaX, float sigmaY) {
        this.sigmaX = sigmaX;
        this.sigmaY = sigmaY;
    }
    ...
    public BufferedImage filter(BufferedImage src, BufferedImage dest) {
        ...
        var newSrc = FloatImages.reuseSourceImage(src, dest.getColorModel());
