...
public class BoundedRangeInputStream
    ...
    /// Overrides [FilterInputStream#read()] to update the value after
    /// the read.
    public int read()
            throws IOException {
        int c = in.read();
    ...
    /// model's value is `maximum - extent` and the lower limit is
    /// `minimum`.
    ///
    ...
    ///
    /// Sets the model's extent. The _newExtent_ is forced to be greater
