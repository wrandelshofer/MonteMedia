...
/// A `Buffer` carries media data from one media processing unit to
/// another.
///
...
public class Buffer {
    ...
    public int length;
    /// Duration of a sample in seconds. Multiply this with `sampleCount`
    ...
    /// Sets `data`, `offset`, `length` and `header` of
